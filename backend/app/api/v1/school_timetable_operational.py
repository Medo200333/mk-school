    ...
    *,
    ...
    return {
        ...
        "mapping_status": {
            ...
            "classtt_direct_slot_source": False,
            "class_block_to_school_class": "blocked_layout_only",
            "day_ordinal": "candidate_only_from_header_not_import_proof",
            "period_ordinal": "missing_from_classtt_body",
            "subject_per_slot": "missing_from_classtt_body",
            "teacher_per_slot": "missing_from_classtt_body",
            "conflict_preview": "blocked_until_real_slot_rows_exist",
        },
        "decoder_gate": {
            "can_build_slot_import_plan": False,
            "can_write_school_timetable_slots": False,
            ...
            "proven_now": [
                "تم إثبات 12 بلوك CLASSTT حقيقي بعد استبعاد CLASSTT_END.",
                "تم استخراج 60 object ids من رؤوس CLASSTT بعد تصحيح alignment.",
                "أجسام CLASSTT لا تحتوي أسماء فصول أو مواد أو مدرسين أو أيام أو حصص.",
                "لم تظهر نوافذ قريبة تجمع subject + teacher ضمن المسافة المفحوصة.",
            ],
            "required_before_db_write": [
                "العثور على مصدر آخر داخل ROZ يحتوي tuple واضح class + day + period + subject + teacher.",
                "أو توفير export رسمي من ASCTT بصيغة CSV/XLS/XLSX يحتوي الجدول الفعلي.",
                "إخراج dry-run rows بعدد خانات واضح.",
                "تشغيل conflict preview على الفصل والمدرس والقاعة قبل أي INSERT.",
            ],
            "warnings": [
                "غياب الدلالة داخل CLASSTT يدعم أنه layout/print metadata وليس lesson tuple.",
                "أسماء أيام الأسبوع لا تظهر نصيًا في ROZ.",
            ],
        },
        ...
        "notes_ar": [
            "هذه لوحة تحليل ROZ وليست تنفيذًا فعليًا.",
            "Phase 8M أثبتت أن CLASSTT مصدر Layout/Print Metadata وليس مصدر slot tuple كامل.",
            "لا توجد كتابة في school.timetable_slots في هذه المرحلة.",
            "أي استيراد فعلي يحتاج مصدرًا آخر يحتوي class + day + period + subject + teacher.",
